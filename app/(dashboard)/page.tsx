...
import { dayEndExclusiveUTC, formatThaiDateUTCISO, getThaiReportingDateUTC } from '@/lib/utils/thai-time'
...
export default async function DashboardPage() {
  ...
  const reportingTodayIso = formatThaiDateUTCISO(reportingToday)
