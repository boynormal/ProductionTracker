 ...
 *
 * รองรับหัวคอลัมน์แบบไฟล์มาตรฐาน (แถวหัวตารางตรวจอัตโนมัติ ภายใน ~20 แถวแรก):
 *   department_name, division_code, division_name, section_code, section_name
 *   (+ department_code ถ้ามี — ถ้าไม่มีจะสร้างรหัสจากชื่อแผนก)
 *
