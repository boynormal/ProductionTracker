...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  ...
  { key: 'menu.production.otPlan', name: 'OT Plan menu', resource: 'menu', action: 'view', category: 'MENU', path: '/production/ot-plan', defaultRoles: ['SUPERVISOR', 'ENGINEER', 'MANAGER', 'ADMIN'] },
  ...
  { key: 'api.production.record.edit', name: 'Edit production records API', resource: 'production.records', action: 'edit', category: 'API', path: '/api/production/records', defaultRoles: ['SUPERVISOR', 'ENGINEER', 'MANAGER', 'ADMIN'] },
  ...
  { key: 'api.production.otplan.write', name: 'Write OT Plan API', resource: 'production.otplan', action: 'write', category: 'API', method: 'POST', path: '/api/production/ot-plan', defaultRoles: ['SUPERVISOR', 'MANAGER', 'ADMIN'] },
  {
