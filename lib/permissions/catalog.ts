...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  ...
  { key: 'api.production.session.delete', name: 'Delete production sessions API', resource: 'production.sessions', action: 'delete', category: 'API', method: 'DELETE', path: '/api/production/sessions', defaultRoles: ['ADMIN'] },
  {
