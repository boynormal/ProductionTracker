...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  ...
  { key: 'api.production.record.delete', name: 'Delete production records API', resource: 'production.records', action: 'delete', category: 'API', method: 'DELETE', path: '/api/production/records/[id]', defaultRoles: ['SUPERVISOR', 'ENGINEER', 'MANAGER', 'ADMIN'] },
  ...
  { key: 'api.production.session.delete', name: 'Delete production sessions API', resource: 'production.sessions', action: 'delete', category: 'API', method: 'DELETE', path: '/api/production/sessions/[id]', defaultRoles: ['SUPERVISOR', 'ENGINEER', 'MANAGER', 'ADMIN'] },
  {
